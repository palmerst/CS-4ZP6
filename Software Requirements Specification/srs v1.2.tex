...
\stepcounter{ReqNum}
\begin{mdframed}
\noindent {\bf Requirement \#:} \arabic{ReqNum} \tabto{4.4cm} {\bf Requirement Type:} \arabic{section}.\arabic{subsection} \tabto{9.9cm} {\bf Use Case:} \cmdSRS@req@use\\[\baselineskip]
\begin{tabularx}{\textwidth}{@{}p{3cm}X@{}}
...
\req{
        use = {\ref{usecase:openigmenu}, \ref{usecase:closeigmenu}},
