...
\ds{Your demonstration plan and proof of concept test could be merged into one section
as they are describing the same thing. The PoC Test subsection is fairly sparse on its
own}
...
\testauto{
    ...
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with a hero object having x-velocity of $-\hyperref[tab:constants]{\alpha}$,
    input = Keyboard function called with simulated left key down stroke,
    output = Hero object x-velocity,
    pass = Hero object x-velocity is $-\hyperref[tab:constants]{\alpha}$
}
...
\testauto{
    ...
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with a hero object having x-velocity of $-\hyperref[tab:constants]{\beta}\times\hyperref[tab:constants]{\alpha}$,
    input = Keyboard function called with simulated left key down stroke,
    output = Hero object x-velocity,
    pass = Hero object x-velocity is $-\hyperref[tab:constants]{\alpha}$
}
...
\testauto{
    ...
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with hero object having x-velocity $-\hyperref[tab:constants]{\alpha}$ situated directly to the right of a wall object,
...
\testauto{
    ...
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with hero object having x-velocity $-\hyperref[tab:constants]{\beta}\times\hyperref[tab:constants]{\alpha}$ situated directly to the right of a wall object,
    input = The chipmunk cpSpaceStep function is called,
    output = Hero object x-velocity,
    pass = Hero object x-velocity is 0
}
...
\testauto{
    ...
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with hero object having x-velocity $\hyperref[tab:constants]{\alpha}$ situated directly to the left of a wall object,
    input = The chipmunk cpSpaceStep function is called,
    output = Hero object x-velocity,
    pass = Hero object x-velocity is 0
}
...
\testauto{
    ...
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with hero object having x-velocity $\hyperref[tab:constants]{\beta}\times\hyperref[tab:constants]{\alpha}$ situated directly to the left of a wall object,
    input = The chipmunk cpSpaceStep function is called,
    output = Hero object x-velocity,
    pass = Hero object x-velocity is 0
}
...
\testauto{
    name = {Floor stops hero in free fall, low speed},
    desc = Tests whether the hero in low speed free fall is stopped by a floor object,
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with hero object with y-velocity $-\hyperref[tab:constants]{\phi}$ situated directly on top of a floor object,
    input = The chipmunk cpSpaceStep function is called,
    output = Hero object y-velocity,
    pass = Hero object y-velocity is 0
}
...
\testauto{
    name = {Floor stops hero in free fall, medium speed},
    desc = Tests whether the hero in medium speed free fall is stopped by a floor object,
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with hero object with y-velocity $-\hyperref[tab:constants]{\chi}$ situated directly on top of a floor object,
    input = The chipmunk cpSpaceStep function is called,
    output = Hero object y-velocity,
    pass = Hero object y-velocity is 0
}
...
\testauto{
    name = {Floor stops hero in free fall, high speed},
    desc = Tests whether the hero in high speed free fall is stopped by a floor object,
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with hero object with y-velocity $-\hyperref[tab:constants]{\psi}$ situated directly on top of a floor object,
    input = The chipmunk cpSpaceStep function is called,
    output = Hero object y-velocity,
    pass = Hero object y-velocity is 0
}
...
\testauto{
    ...
    desc = Tests whether the hero is obstructed by a ceiling in mid jump,
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with hero object having y-velocity $\hyperref[tab:constants]{\lambda}$ situated directly under a ceiling object,
    input = The chipmunk cpSpaceStep function is called,
    output = Hero object y-velocity,
...
\testauto{
    ...
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with hero object having x-velocity $-\hyperref[tab:constants]{\zeta}$ situated directly to the right of a wall object,
    input = The chipmunk cpSpaceStep function is called,
    output = Hero object x-velocity,
    pass = Hero object x-velocity is 0
}
...
\testauto{
    ...
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with hero object having x-velocity $-\hyperref[tab:constants]{\eta}$ situated directly to the right of a wall object,
    input = The chipmunk cpSpaceStep function is called,
    output = Hero object x-velocity,
    pass = Hero object x-velocity is 0
}
...
\testauto{
    ...
    desc = Tests whether an enemy is stopped by a wall object while moving left at high speed,
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with hero object having x-velocity $-\hyperref[tab:constants]{\theta}$ situated directly to the right of a wall object,
    input = The chipmunk cpSpaceStep function is called,
    output = Hero object x-velocity,
    pass = Hero object x-velocity is 0
}
...
\testauto{
    ...
    desc = Tests whether an enemy is stopped by a wall object while moving right at low speed,
    type = {Unit Test (dynamic, automated)},
...
\testauto{
    ...
    desc = Tests whether an enemy is stopped by a wall object while moving right at medium speed,
    type = {Unit Test (dynamic, automated)},
...
\testauto{
    name = Floor supports stationary enemy,
    desc = Tests whether an enemy is supported by a floor object,
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with a stationary enemy object situated directly on top of a floor object,
    input = The chipmunk cpSpaceStep function is called,
...
\testauto{
    name = {Floor stops enemy in free fall, low speed},
    desc = Tests whether an enemy in low speed free fall is stopped by a floor object,
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with an enemy object with y-velocity $-\hyperref[tab:constants]{\phi}$ situated directly on top of a floor object,
    input = The chipmunk cpSpaceStep function is called,
    output = Enemy object y-velocity,
    pass = Enemy object y-velocity is 0
}
...
\testauto{
    name = {Floor stops enemy in free fall, medium speed},
    desc = Tests whether an enemy in medium speed free fall is stopped by a floor object,
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with an enemy object with y-velocity $-\hyperref[tab:constants]{\chi}$ situated directly on top of a floor object,
    input = The chipmunk cpSpaceStep function is called,
    output = Enemy object y-velocity,
    pass = Enemy object y-velocity is 0
}
...
\testauto{
    name = {Floor stops enemy in free fall, high speed},
    desc = Tests whether an enemy in high speed free fall is stopped by a floor object,
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with an enemy object with y-velocity $-\hyperref[tab:constants]{\psi}$ situated directly on top of a floor object,
    input = The chipmunk cpSpaceStep function is called,
    output = Enemy object y-velocity,
    pass = Enemy object y-velocity is 0
}
...
\testauto{
    name = Hero is knocked back when colliding with enemy from left,
    desc = Tests whether a the hero is knocked back to the left when an enemy is collided with from the left,
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with a hero object with an x-velocity $\hyperref[tab:constants]{\alpha}$ located directly to the left of a stationary enemy object,
    input = The chipmunk cpSpaceStep function is called,
    output = Hero object x-velocity,
    pass = Hero object x-velocity is $-\hyperref[tab:constants]{\omega}\times\hyperref[tab:constants]{\alpha}$
}

\testauto{
    name = Hero is knocked back when colliding with enemy from right,
    desc = Tests whether a the hero is knocked back to the right when an enemy is collided with from the right,
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with a hero object with an x-velocity $-\hyperref[tab:constants]{\alpha}$ located directly to the right of a stationary enemy object,
    input = The chipmunk cpSpaceStep function is called,
    output = Hero object x-velocity,
    pass = Hero object x-velocity is $\hyperref[tab:constants]{\omega}\times\hyperref[tab:constants]{\alpha}$
}
...
\testauto{
    ...
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with a hero projectile object with an x-velocity $-\hyperref[tab:constants]{\gamma}$ located directly to the right of a stationary enemy object,
    input = The chipmunk cpSpaceStep function is called,
    output = State of the space,
...
\testauto{
    ...
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with an enemy projectile object with an x-velocity $-\hyperref[tab:constants]{\gamma}$ located directly to the right of  a stationary hero object,
    input = The chipmunk cpSpaceStep function is called,
    output = State of the space,
...
\testauto{
    ...
    input = The chipmunk cpSpaceStep function is called,
    output = Enemy health,
    pass = Enemy health is equal to $100-\hyperref[tab:constants]{\xi}$ 
}
...
\testauto{
    ...
    input = The chipmunk cpSpaceStep function is called,
    output = Enemy health,
    pass = Enemy health is equal to $100-\hyperref[tab:constants]{\pi}$
}
...
\testauto{
    ...
    input = The chipmunk cpSpaceStep function is called,
    output = Enemy health,
    pass = Enemy health is equal to $100-\hyperref[tab:constants]{\rho}$
}

\testauto{
    name = Enemy is killed when hit points reach zero,
    desc = Tests whether an enemy is killed when hit points reach zero,
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with a hero pistol projectile object with an x-velocity $-\hyperref[tab:constants]{\gamma}$ located directly to the right of a an enemy object with 1 hit point,
    input = The chipmunk cpSpaceStep function is called,
    output = State of the space,
...
\testauto{
    name = Hero health reduced when hit by a weak enemy attack,
    desc = Tests whether hero health is properly reduced when hit by a weak enemy attack,
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with a weak enemy projectile object with an x-velocity $-\hyperref[tab:constants]{\gamma}$ located directly to the right of a hero object with 100 hit points,
    input = The chipmunk cpSpaceStep function is called,
    output = Hero health,
    pass = Hero health is equal to $100-\hyperref[tab:constants]{\Xi}$
}

\testauto{
    name = Hero health reduced when hit by a moderate enemy attack,
    desc = Tests whether hero health is properly reduced when hit by a moderate enemy attack,
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with a weak enemy projectile object with an x-velocity $-\hyperref[tab:constants]{\gamma}$ located directly to the right of a hero object with 100 hit points,
    input = The chipmunk cpSpaceStep function is called,
    output = Hero health,
    pass = Hero health is equal to $100-\hyperref[tab:constants]{\Pi}$
}

\testauto{
    name = Hero health reduced when hit by a strong enemy attack,
    desc = Tests whether hero health is properly reduced when hit by a strong enemy attack,
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with a weak enemy projectile object with an x-velocity $-\hyperref[tab:constants]{\gamma}$ located directly to the right of a hero object with 100 hit points,
    input = The chipmunk cpSpaceStep function is called,
    output = Hero health,
    pass = Hero health is equal to $100-\hyperref[tab:constants]{\Sigma}$
}

\testauto{
    name = Hero is killed when hit points reach zero,
    desc = Tests whether hero is killed when hit points reach zero (game over),
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state with a weak enemy projectile object with an x-velocity $-\hyperref[tab:constants]{\gamma}$ located directly to the right of a hero object with 1 hit point,
    input = The chipmunk cpSpaceStep function is called,
...
\testauto{
    name = {Load file from menu, file type invalid},
    desc = Tests that exception is thrown if an invalid file is attempted to be loaded,
    type = {Unit Test (dynamic, automated)},
    init = Main menu state,
...
\testauto{
    name = Save game,
    desc = Tests whether the game state can be successfully saved,
    type = {Unit Test (dynamic, automated)},
    init = Custom in-game state,
...
Once the game mechanics systems have been implemented and shown to be working correctly through the testing described in \hyperref[sec:mechanicstesting]{\S\ref*{sec:mechanicstesting}}, the game itself can be built on top.  The design of the game can be broken down into the design of the game world, enemy artificial intelligence, graphics, and sound.  Automated testing for this phase would be time-consuming and difficult to implement.  Therefore, all of the game design testing will consist of manual tests.
...
\testmanual{
    ...
    desc = Tests if hero movement/attack animations are properly implemented,
    type = {Functional (dynamic, manual)},
    user = Development team,
...
\testmanual{
    ...
    desc = Tests if enemy movement/attack animations are properly implemented,
    type = {Functional (dynamic, manual)},
    user = Development team,
...
\testmanual{
    ...
    desc = Game is compared with SRS document to ensure functional requirements are met,
    type = {Functional (dynamic, manual)},
    user = {Development team},
    pass = All functional requirements are met
}

\ds{You should specify which of your test cases cover which of your requirements
and then check to ensure all of your requirements are being covered. If they aren't,
then you should create more test cases. Currently this section isn't really saying
anything new.}
...
\testmanual{
    ...
    \ds{Good. Don't forget to update it!}
}

\subsubsection{User Experience Testing}
The following non-functional requirements will be tested via a user experience survey administered to a testing group (see \hyperref[sec:userexp]{\S\ref*{sec:userexp}}).
...
\testmanual{
    ...
    type = {Functional (dynamic, manual)},
    user = {Testing group},
    pass = {Phase I average survey score within $\hyperref[tab:constants]{\Psi}$ of 5; Phase II average survey score improves on Phase I score by $\hyperref[tab:constants]{\Phi}$}
}
...
\testmanual{
    ...
    type = {Functional (dynamic, manual)},
    user = {Testing group},
    pass = {Phase I average survey score of at least $\hyperref[tab:constants]{\Omega}$; Phase II average survey score improves on Phase I score by $\hyperref[tab:constants]{\Phi}$}
}
